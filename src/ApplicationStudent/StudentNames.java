...
public class StudentNames {
    ...
    public static void main(String[] args) throws IOException {
        String students = Stream.generate(StudentNames::generateRandomFullName).limit(100)
    ...
    private static String generateRandomFullName() {
        ...
        if (isMale) {
            return generateRandomName(maleLastNames, maleNames, malePatronymics);
        } else {
            return generateRandomName(femaleLastNames, femaleNames, femalePatronymics);
        }
    }

    private static String generateRandomName(List<String> lastNames, List<String> names, List<String> patronymics) {
